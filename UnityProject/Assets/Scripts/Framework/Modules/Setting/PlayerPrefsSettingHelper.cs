...
namespace Framework.Modules.Setting
{
    ...
    public class PlayerPrefsSettingHelper : SettingHelperBase
    {
        ...
        public override string[] GetAllSettingNames() => throw new NotImplementedException();

        /// <summary>
        /// 获取所有游戏配置项的名称。
        /// </summary>
        /// <param name="results">所有游戏配置项的名称。</param>
        public override void GetAllSettingNames(List<string> results) => throw new NotImplementedException();
        ...
        public override T GetObject<T>(string settingName, T defaultObj)
        {
            ...
            return json == null ? defaultObj : Utility.Json.ToObject<T>(json);
        }
        ...
        {
            string json = GetString(settingName, null);
            return json == null ? defaultObj : Utility.Json.ToObject(objectType, json);
        }
