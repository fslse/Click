...
namespace Framework.Modules.Setting
{
    ...
    {
        private const string SettingFileName = "QTESetting.dat";

        private string filePath;
        private DefaultSetting settings;
        private DefaultSettingSerializer serializer;

        /// <summary>
        /// 获取游戏配置项数量。
        /// </summary>
        public override int Count => settings?.Count ?? 0;
        ...
        /// 获取游戏配置。
        /// </summary>
        public DefaultSetting Setting => settings;

        /// <summary>
        /// 获取游戏配置序列化器。
        /// </summary>
        public DefaultSettingSerializer Serializer => serializer;
        ...
        public override bool Load()
        {
            ...
            {
                GameLog.LogWarning($"Load settings failure with exception '{exception}'.");
                return false;
            }
        }
        ...
        public override bool Save()
        {
            try
            {
                ...
                return serializer.Serialize(fileStream, settings);
            }
            catch (Exception exception)
            {
                GameLog.LogWarning($"Save settings failure with exception '{exception}'.");
                return false;
            }
        }
        ...
        {
            return settings.GetAllSettingNames();
        }
        ...
        {
            settings.GetAllSettingNames(results);
        }
        ...
        {
            return settings.HasSetting(settingName);
        }
        ...
        {
            return settings.RemoveSetting(settingName);
        }
        ...
        {
            return settings.GetBool(settingName);
        }
        ...
        {
            return settings.GetBool(settingName, defaultValue);
        }
        ...
        {
            settings.SetBool(settingName, value);
        }
        ...
        {
            return settings.GetFloat(settingName, defaultValue);
        }
        ...
        {
            settings.SetFloat(settingName, value);
        }
