...
namespace Framework.Core.Event
{
    ...
    public static class GameEvent
    {
        ...
        {
            return eventManager.Dispatcher.AddEventListener(eventType, handler);
        }
        ...
        {
            eventManager.Dispatcher.RemoveEventListener(eventType, handler);
        }
        ...
        {
            return eventManager.Dispatcher.AddEventListener(RuntimeId.ToRuntimeId(eventType), handler);
        }
        ...
        {
            eventManager.Dispatcher.RemoveEventListener(RuntimeId.ToRuntimeId(eventType), handler);
        }
        ...
        {
            return eventManager.GetInterface<TArg1>();
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1, arg2);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1, arg2, arg3);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1, arg2, arg3, arg4);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1, arg2, arg3, arg4, arg5);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, handler);
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType));
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), arg1);
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), arg1, arg2);
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), arg1, arg2, arg3);
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), arg1, arg2, arg3, arg4, arg5);
        }
        ...
        {
            eventManager.Dispatcher.Send(eventType, arg1, arg2, arg3, arg4, arg5, arg6);
        }
        ...
        {
            eventManager.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), handler);
        }
